  ...
  return (
    <div className={classes.root}>
      ...
      <Box mt={2} fontSize="body2.fontSize" color="error.main" >
        * This is an autogenerated summary based on a semantic search of abstracts. 
          Always examine the sources before accepting this conclusion. 
          If the evidence only mentions the topic or the evidence is not clear, the summary 
          will likely not clearly answer the question.
      </Box>
